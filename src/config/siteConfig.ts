...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://takiyu-wiki.ccwu.cc/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "1590135171", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"assets/desktop-banner/上依那couple2.png",
				"assets/desktop-banner/上依那couple1.png",
			], // 桌面横幅图片
			mobile: [
